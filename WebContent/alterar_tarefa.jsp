...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<div>
				<a href="Logout.do" class="txt1"><%=nome%></a>
			</div>
		</div>
	</nav>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w"
					method="post" action="AlterarTarefa.do">
					<span class="login100-form-title p-b-51"> Alterar Tarefa </span>

					<input type="hidden" name="id_tarefa" value="<%=t.getId()%>" readonly>
					<input type="hidden" name="email_usuario_tarefa" value="<%=t.getEmailUsuario()%>" />

					<div class="wrap-input100 validate-input m-b-16"
						data-validate="Titulo é obrigatório">
						<input class="input100" type="text" name="titulo_tarefa"
							placeholder="Titulo da Tarefa" value="<%=t.getTitulo()%>"> <span
					...
					<div class="wrap-input100 validate-input m-b-16"
						...
						<input class="input100" type="text" name="descricao_tarefa"
							placeholder="Descrição da Tarefa" value="<%=t.getDescricao()%>"> <span
							class="focus-input100"></span>
					</div>
